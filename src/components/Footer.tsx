    ...
    return (
        <div className="w-full h-14 grid grid-cols-2 border-t text-light-primary md:grid-cols-12 xl:grid-cols-12">
            ...
            <div className="grid grid-cols-3 md:flex md:col-span-4">
                ...
                <Link href={'https://www.linkedin.com/in/siravit-thaenrattanavijit-137b15244/'} target='_blank' className="grid place-content-center border-r md:w-[60px] hover:text-white duration-150"><LinkedInIcon fontSize='large' /></Link>

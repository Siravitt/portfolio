...
export default function NavBar() {
    ...
    return (
        <div className="h-14 grid grid-cols-10 text-light-primary border-b md:grid-cols-12">
            ...
            <Link href={'/projects'} className={`hidden place-content-center ${pathname === "/projects" ? "text-white border-b-2 border-b-plum" : ""} md:border-r md:grid md:col-span-2 xl:col-span-1 hover:text-white hover:text-lg duration-150`}>_projects</Link>
            <Link href={'/contact-me'} className={`hidden place-content-center ${pathname === "/contact-me" ? "text-white border-b-2 border-b-plum" : ""} md:border-l md:grid md:col-span-2 xl:col-span-1 xl:col-start-12 hover:text-white hover:text-lg duration-150`}>_contact-me</Link>
